                              ...
                              Container(
                                ...
                                child: Text("Awards"
                                  ...
                                  style: Theme.of(context).textTheme.body2.copyWith(
                                      color: people.isDark?Colors.black:Colors.black
                                  ),),
                              ),
                              Container(
                                width: double.infinity,
                                padding: EdgeInsets.only(left: 15.0,right: 15.0,bottom: 16.0),
                                child: Text(people.awards,
                                  style: TextStyle(color: people.isDark?Colors.black:Colors.black),),
                              )
